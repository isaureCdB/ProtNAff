#!/usr/bin/env python3
#Author: Sjoerd J. de Vries (INSERM)
...
parser.add_argument("--selection", help="cluster only selected structures. Keep initial indices")
...
if args.selection is not None:
    sel = [ int(l.split())-1 for l in open(args.selection)]
