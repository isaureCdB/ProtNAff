...
tp_seqsigs, tp_scores = readf("pabp-prot-motif-evaluate-predictions-truepos.txt")
fp_seqsigs, fp_scores = readf("pabp-prot-motif-evaluate-predictions-falsepos.txt")
rrm_doublestack_seqsigs = set(
    [l.strip().split()[1] for l in open("rrm-xox-seqsigs.list")]
)
rrm_nonstack_seqsigs = set(
    [l.strip().split()[1] for l in open("rrm-nonxox-seqsigs.list")]
)
