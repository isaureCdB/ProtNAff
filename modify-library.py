...
p.add_argument("pdb_code", help="PDB code from the library that is to be replaced")
...
p.add_argument("--conformers", help="Conformer indices (in X-conformer.list, starting from 0) for each modified library structure")
